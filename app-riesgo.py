    ...
    html.Div([
        ...
        html.Div([
            html.Div([
                ...
                dcc.RangeSlider(2005, 2021, 1, value=[2019, 2021], marks=None, tooltip={"placement": "bottom", "always_visible": True}, id='year-slider', className='range-slider')
                
            ],className='row1-col1-row1'), # filter y slider
            
            html.Div([
                
                html.P('Lorem ipsum dolor sit amet consectetur. Duis ut accumsan ipsum vitae quis pellentesque iaculis potenti scelerisque. Nulla vitae nec sit rhoncus sed.', className='risk-description'),
                
                html.Div([
                    
                    dcc.Graph(id='risk-map',style={'width': '50vw', 'height': '40vh'}, className='experience-map'),
        ...
        html.Div([
            ...
            html.Div([
                ...
                html.P('Lorem ipsum dolor sit amet consectetur. Duis ut accumsan ipsum vitae quis pellentesque iaculis potenti scelerisque. Nulla vitae nec sit rhoncus sed.', className='risk-table-description'),
...
def risk_line(clk_data):
    ...
    fig.update_layout(margin=dict(l=0, r=0, t=70, b=50),paper_bgcolor='rgba(255, 255, 255, 0)', plot_bgcolor='rgba(255, 255, 255, 1)')
